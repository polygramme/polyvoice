...
observer. Copy it into a recipe when it needs tools or a different pipeline.
    ...
    python -m polyvoice.pipecat.bot -t eval --port 7900   # Pipecat Evals / polyvoice rollouts (text mode: no STT/TTS)
    python -m polyvoice.pipecat.bot -t webrtc             # browser client, Roark self-hosted simulations
    python -m polyvoice.pipecat.bot -t daily              # Daily room (Coval / Cekura / Roark via Pipecat Cloud)
