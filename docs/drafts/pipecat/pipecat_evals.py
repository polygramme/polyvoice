...
class LLMEndpoint:
    ...
    def service(self) -> OpenAILLMService:
        return OpenAILLMService(base_url=self.base_url, api_key=self.api_key,
...
#   judge: {eval: {factory: polyvoice.verifiers.pipecat_evals.judge_llm}}
#   simulator: {factory: polyvoice.verifiers.pipecat_evals.persona_llm}
